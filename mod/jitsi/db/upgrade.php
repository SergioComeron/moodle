...
function xmldb_jitsi_upgrade($oldversion) {
    ...
    if ($oldversion < 2021030501) {
        ...
        upgrade_mod_savepoint(true, 2021030501, 'jitsi');
    }

    if ($oldversion < 2021042800) {
        // Define field introformat to be added to jitsi.
        $table = new xmldb_table('jitsi');
        $field = new xmldb_field('record', XMLDB_TYPE_INTEGER, '1', null, null, null, null, 'minpretime');
        $field2 = new xmldb_field('recording', XMLDB_TYPE_TEXT, null, null, null, null, null, 'record');
        ...
        // Jitsi savepoint reached.
        upgrade_mod_savepoint(true, 2021042800, 'jitsi');
    }
